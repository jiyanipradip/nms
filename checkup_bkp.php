...
?>
<style type="text/css">
	 .dTable1 tbody td { overflow: hidden !important; padding: 8px  !important; }
    .gradeGreen {background-color: #99ff99;}
</style>
...
<div id="rightSide">
    ...
    <div class="wrapper">
        ...
        <div class="title"><img src="images/icons/dark/full2.png" alt="" class="titleIcon" /><h6><? if($iidArray[$iid]!=""){ echo $iidArray[$iid]; }else{ echo "Please Select Incoming Source"; }?></h6></div>                                         
            <table cellpadding="0" cellspacing="0" border="0" class="display dTable1">
