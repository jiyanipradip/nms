...
if($_POST['submit'])
{
	...
	$txtuserlog  = $_POST['txtusername'];
	$txtipadd    = $_SERVER['REMOTE_ADDR'];
	
	if($txtusername!="" && $txtpassword!="")
	{
		$sqlinsert = "insert into userlogin (username,password,emailid,phoneNo,userType,crdate,crtime,userlog,ipadd) values('$txtusername','$txtpassword','$txtemail','$txtphone','$txtusertype',now(),now(),'$txtuserlog','$txtipadd')";
		//echo $sqlinsert."<br>";
		$sqlresult  = mysql_query($sqlinsert) or die(mysql_error());
		header("location:userlistmaster.php"); die;
	}else
	{
                   ...
                   <div class="formRow">
                    ...
                    <div class="formRow">
                     ...
                     <div class="formRow">
                        <label>PhoneNo :</label>
                        <div class="formRight"><span class="oneTwo">
                        <input type="text" class="validate[required]" name="txtphone" id="txtphone" value="<?php echo $sql_data['phoneNo'];?>"/></span></div>
                        <div class="clear"></div>
                    </div>
