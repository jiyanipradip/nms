...
$id = $_GET['id'];
$sqlselect = "SELECT * from paramgroup where id='$id'";
//echo $sqlselect."<br>";
...
<div id="rightSide">
    ...
    <div class="wrapper">
        ...
        <?php
			...
			{
			?>
        <form id="validate" class="form" method="post" action="functions.php?action=modifyparamgroup&id=<? echo $id; ?>">
            <fieldset>
                <div class="widget">                    
                   <div class="formRow">
                        <label>Name :</label>
                    ...
                    <input type="submit" name="submit" value="submit" class="redB" /></div>
							<a href="paramgrouplist.php" title="" class="button redB" style="margin: 5px;"><span><< Back</span></a>
                    <div class="clear"></div>                    
                </div>
            </fieldset>
        </form>
        <? } else { ?>
		  <form id="validate" class="form" method="post" action="functions.php?action=addparamgroup">
            <fieldset>
                <div class="widget">                    
                   <div class="formRow">
                        <label>Name :</label>
